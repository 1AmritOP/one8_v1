...
const Footer = () => {
  return (
    <>
      <footer className='relative w-full flex max-md:flex-wrap gap-4 items-center justify-between max-md:justify-center min-h-[40vh] bg-black p-10 text-white'>
        <section className='w-52 h-40 '>
          <h1 className=' mb-2 font-bold  text-yellow-400 '>SERVICES</h1>
          <li><a href="#">Link</a></li>
          <li><a href="#">Link</a></li>
          <li><a href="#">Link</a></li>
          <li><a href="#">Link</a></li>
        ...
        <section className='w-52 h-40  max-[460px]:h-20'>
          <h1 className=' mb-2 font-bold text-yellow-400 '>SOCIAL</h1>
        ...
        <section className='w-52 h-40 '>
          <img src={giftCard} alt="img" className=' h-full w-full object-fill' />
        </section>
      </footer>
    </>
  )

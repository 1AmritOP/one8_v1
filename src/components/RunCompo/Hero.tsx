...
const Hero = () => {
  ...
  return (
    <>
        <div className="hero min-h-[calc(100vh-4rem)]  w-full  flex max-md:flex-col items-center justify-between p-10">

            <div className="left h-full w-1/2 max-md:w-full max-md:h-[60vh] ">
                <div className="text h-full w-full flex items-start justify-center flex-col">
                    <h1 className=' reveal font-bold text-5xl'>Join Legends of</h1>
                    <h1 className=' text-5xl font-bold reveal'>Fitness world</h1>
                    <p className=' my-4 para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium, quia?</p>
                    <div className="mt-6 flex max-w-md gap-x-4 input">
            ...
            <div className="right h-full w-1/2 max-md:w-full max-md:h-96 ">
                <div className="video  ml-auto   h-80 w-72 max-md:w-60 max-sm:w-52 max-sm:h-72  relative max-md:m-auto ">
                    ...
                    <div className="content absolute h-48 w-40 bg-red-950 z-10 -bottom-20 -left-20  overflow-hidden">
